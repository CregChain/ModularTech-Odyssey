...
//线程设置
MachineModifier.setMaxThreads("multi_thread_electric_blast_furnace_mk1",8);
...
function glpf(Inputs as IIngredient[],Output as IIngredient[],XQlevel as int,time as int,energy as int){
    ...
    RecipeBuilder.newBuilder("multi_thread_electric_blast_furnace_mk1" + Outputname, "multi_thread_electric_blast_furnace_mk1", time,XQlevel)
        .addInputs(Inputs)
        ...
        .addFactoryStartHandler(function(event as FactoryRecipeStartEvent) {
            ...
            if (xqdj < 2147483647){
                    ...
                    bl.addModifier("energy", RecipeModifierBuilder.create("modularmachinery:energy", "input",ebeil, 1, false).build());
                    bl.addModifier("time_1", RecipeModifierBuilder.create("modularmachinery:duration", "input",tbeil1, 1, false).build());
                    bl.addModifier("time_2", RecipeModifierBuilder.create("modularmachinery:duration", "input",tbeil2, 1, false).build());
                } else {
                    val ebeil = 1 - energy;
                    val tbeil1 = 1 - time;
                    val tbeil2 = 1;
                    bl.addModifier("energy", RecipeModifierBuilder.create("modularmachinery:energy", "input",ebeil, 0, false).build());
                    bl.addModifier("time_1", RecipeModifierBuilder.create("modularmachinery:duration", "input",tbeil1, 0, false).build());
                    bl.addModifier("time_2", RecipeModifierBuilder.create("modularmachinery:duration", "input",tbeil2, 1, false).build());
                }
        })
