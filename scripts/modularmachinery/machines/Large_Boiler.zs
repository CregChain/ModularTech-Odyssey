//This script was created by ohxihh，and has reference Kasumi_ Nova's script;
...
MMEvents.onMachinePostTick("large_boiler", function(event as MachineTickEvent) {
    ...
    if (controller.isWorking) {
        ...
        //if (newEnergy != temp) {
            ...
            controller.addModifier("liquid_input", RecipeModifierBuilder.create("modularmachinery:fluid", "input", modifier, 1, false).build());
        //}
    } else {
        //停止时减少温度
...
RecipeBuilder.newBuilder("steam1", "large_boiler", 120)
...
RecipeBuilder.newBuilder("steam2", "large_boiler", 240)
.addFluidPerTickInput(<liquid:water>*10)
.addItemInput(<ore:fuelCoke>*1)
.addFluidPerTickOutput(<liquid:steam>*100).setIgnoreOutputCheck(true)
.build();

RecipeBuilder.newBuilder("steam3", "large_boiler", 24)
.addFluidPerTickInput(<liquid:water>*10)
.addItemInput(<ore:logWood>*1)
.addFluidPerTickOutput(<liquid:steam>*100).setIgnoreOutputCheck(true)
.build();

RecipeBuilder.newBuilder("steam4", "large_boiler", 12)
.addFluidPerTickInput(<liquid:water>*10)
.addItemInput(<ore:plankWood>*1)
.addFluidPerTickOutput(<liquid:steam>*100).setIgnoreOutputCheck(true)
.build();

RecipeBuilder.newBuilder("steam5", "large_boiler", 180)
.addFluidPerTickInput(<liquid:water>*10)
.addItemInput(<ore:itemBlazeRod>*1)
.addFluidPerTickOutput(<liquid:steam>*100).setIgnoreOutputCheck(true)
.build();